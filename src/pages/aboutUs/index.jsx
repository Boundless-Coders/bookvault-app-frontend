...
//   className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center transition-transform duration-300 transform hover:scale-105">
...
//   <motion.div 
//   whileHover={{ scale: 1.05 }}
//   className="bg-white p-6 rounded-lg shadow-lg  border-t-4 border-green-500 transition-transform duration-300 transform hover:scale-105">
...
//   const teamMembers = [
//     { name: "Frank Koomson", position: "Founder & CEO", imageUrl: "/api/placeholder/150/150" },
//     { name: "Mary Magdalene", position: "Head Librarian", imageUrl: "/api/placeholder/150/150" },
//     { name: "Believe Kwamitse", position: "Lead Developer", imageUrl: "/api/placeholder/150/150" },
//     { name: "Roberta Ayettey", position: "UX Designer", imageUrl: "/api/placeholder/150/150" },
//     { name: "Daniel Essel", position: "Marketing Director", imageUrl: "/api/placeholder/150/150" },
//     // { name: "Alex Thompson", position: "Customer Success Manager", imageUrl: "/api/placeholder/150/150" }
//   ];

//   const features = [
//     {
//       title: "Detailed Book Information",
//       description: "Stores and access comprehensive book data, including descriptions, author details, and genres."
//     },
//     {
...
//       description: "Success and error notifications help keep track of actions, ensuring a smooth user experience."
//     }
//   ];
...
//         </p>
//         <p className="mb-4">
//           Founded in 2023, our mission is to simplify the way individuals and institutions catalog, track, and discover books. We believe that a well-organized library is a gateway to knowledge and imagination.
//         </p>
...
//         </div>
//         {/* <div className="mt-12">
//           <Link to="/about" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded inline-block">
//             Learn More About Us
//           </Link>
//         </div> */}
//       </div>
